...
function Contract(props) {
    ...
    useEffect(() => {
        axios.get(`https://backend.indowings.com/reads/${id}`)
            .then(res => {
    ...
    const handleGenerateContract = async () => {
        ...
        try {
            const response = await axios.post('https://backend.indowings.com/api/generate-contract', {
    ...
    const handleInitiateContract = async () => {
        ...
        try {
            ...
            await axios.post('https://backend.indowings.com/api/initiate-contract', {
                pdf: contractPdf,
            ...
            const downloadResponse = await axios.get(contractPdf, {
            ...
            link.href = url;
            link.setAttribute('download', 'contract.pdf'); // You can change the file name here

...
function Update_products(props) {
  ...
  useEffect(() => {
    axios
      .get(`https://backend.indowings.com/read_products/${product_id}`)
      .then((res) => {
  ...
  const handleUpdate = (event) => {
    ...
    axios
      .put(`https://backend.indowings.com/update_products/${product_id}`, values)
      .then((res) => {
        console.log(res);
        navigate("/products");
      })
        ...
        <form onSubmit={handleUpdate}>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <input
              ...
              onChange={(e) =>
                setValues({ ...values, brochure: e.target.value })
              }
            />
          </div>
          <div style={{ marginBottom: "20px" }}>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <input
              ...
              value={values.partner_price}
              onChange={(e) =>
                setValues({ ...values, partner_price: e.target.value })
              }
            />
          </div>
          <div style={{ marginBottom: "20px" }}>

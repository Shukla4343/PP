...
function EditStatus(props) {
  ...
  const handleUpdate = (event) => {
    ...
    axios
      .put(`https://backend.indowings.com/edistatus/${order_id}`, values)
      .then((res) => {
        console.log(res);
        navigate("/orders");
      })
  ...
  useEffect(() => {
    axios
      .get(`https://backend.indowings.com/read_order/${order_id}`)
      .then((res) => {
        setOrder(res.data[0]);
      })
      .catch((err) => console.log(err));
  ...
  const handleDelete = (order_id) => {
    axios
      .delete(`https://backend.indowings.com/delete_order/${order_id}`)
      .then((res) => {
        navigate("/orders");
      })
      .catch((err) => console.log(err));

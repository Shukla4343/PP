...
const ProfileEdit = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://backend.indowings.com/allpartnersprofile`)
      .then((res) => {
        setProfile(res.data);
      })
  ...
  useEffect(() => {
    ...
    if (existingProfile) {
      const formattedProfile = {
        ...existingProfile,
        // founding_date: existingProfile.founding_date.split("T")[0], // This line seems unnecessary since founding_date isn't being used
      };
      setValues(formattedProfile);
    }
  }, [profile, user]);
  ...
  const handleSubmit = async (e) => {
    ...
    await Promise.all([
      axios
        .post("https://backend.indowings.com/profile_insert/", formattedValues)
        .then((res) => {
          console.log(res);
        })
        .catch((err) => console.log(err)),
      ...
      .then(() => {
        navigate("/partnerprofiledetails");
      })
      .catch((e) => {
        console.log("err-->", e);
      });
      ...
      >
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="mb-3">
              <label htmlFor="">Registered E-mail Address:</label>
              <input
                type="text"
            ...
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) => {
                  const input = e.target.value.replace(/[^A-Za-z0-9\s]/gi, "");
                  setValues({ ...values, company_name: input });
                }}
              />
            </div>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const alphabeticValue = inputVal.replace(/[^A-Za-z]/g, "");
                  setValues({ ...values, city: alphabeticValue });
                }}
              />
            </div>
            <div className="mb-3">
          ...
          <div className="col-md-6">
              ...
              <div className="input-group">
                <div className="input-group-prepend">
                  {/* <input
                      ...
                      onChange={(e) =>
                        setValues({ ...values, country_code: e.target.value })
                      }
                    /> */}
                    <select
                    className="form-control"
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setValues({ ...values, reg_phone: truncatedValue });
                  }}
                />
              </div>
            </div>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) => {
                  const inputVal = e.target.value;
                  const alphabeticValue = inputVal.replace(/[^A-Za-z\s]/g, "");
                  setValues({ ...values, key_name: alphabeticValue });
                }}
              />
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const numericValue = inputVal.replace(/\D/g, "");
                  const truncatedValue = numericValue.slice(0, 10);
                  setValues({ ...values, key_phone: truncatedValue });
                }}
              />
        ...
        <div className="mt-4" style={{ flexBasis: "100%" }}>
          {/* <Link to="/partnerprofiledetails" className="btn btn-primary me-2">
              Back
            </Link> */}
          <button
            type="submit"

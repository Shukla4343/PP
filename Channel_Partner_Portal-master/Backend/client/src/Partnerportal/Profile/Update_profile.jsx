...
function Update_profile(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    await Promise.all([
      ...
      axios
        .post("https://backend.indowings.com/updateStep", {
          count: 1,
          user: user.username,
        })
        .then((res) => {
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (len <= 10 && Numeric.test(inputValue)) {
                      setValues({ ...values, reg_phone: inputValue });
                    }
                  }}
                  maxLength={10}
                  minLength={10}
            ...
            <div className="mb-3">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const len = inputValue.length;
                  if (len <= 10 && Numeric.test(inputValue)) {
                    setValues({ ...values, key_phone: inputValue });
                  }
                }}
                maxLength={10}
                minLength={10}

  ...
  function Partner_KYC(props) {
    ...
    useEffect(() => {
      const fetch = async () => {
        await axios
          .post(`https://backend.indowings.com/fetchRegDetails`, {
            user: user.username,
          })
          .then((res) => {
    ...
    useEffect(() => {
      const fetch = async () => {
        await axios
          .get(`https://backend.indowings.com/fetchDirectors/${profile.id}`)
          .then((res) => {
    ...
    const onSubmit = async (e) => {
      ...
      try {
        ...
        await axios.post("https://backend.indowings.com/updateStep", {
          count: 4,
          user: user.username,
        });
      ...
      >
        ...
        >
          ...
          <div className="d-flex justify-content-end mb-4">
            <Link to="/insert_kyc" className="btn btn-success">
